...
<div
	id="resume-container"
	style="width: calc(1200px - 2 * {borderPaddingHorizontal}px);{borderPaddingHorizontalStyle} {borderPaddingVerticalStyle}"
>
	<Header />
	<div id="grid-container">
		{#each Object.keys(sections) as section}
			<div
				class="section-name-container"
				style="{spaceBetweenSectionsStyle} {gridCentralSpaceStyle}"
			>
				<p
					class="section-name"
					style="color: rgb(0, 0, 0, 0.5); font-size: {fontSize * 1.2}rem; {textSettingsStyle}"
				>
